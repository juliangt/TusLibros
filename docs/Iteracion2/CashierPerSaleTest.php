...
class CashierPerSaleTest extends TestCase implements MerchantProcessor
{
    ...
    public function testCanNotCheckoutAnEmptyCart()
    {
        ...
        try {
            new CashierPerSale($salesBook, $cart, $this->testObjects->notExpiredCreditCard(), $this->testObjects->today(), $this);
            $this->fail();
        } catch (Error $error){
    ...
    public function testCalculatesSalesTotalCorrectly()
    {
        ...
        $salesBook = array();
        $cashier = new CashierPerSale($salesBook, $cart, $this->testObjects->notExpiredCreditCard(), $this->testObjects->today(), $this);
    ...
    public function testCanNotCheckoutWithExpiredCreditCard()
    {
        ...
        try {
            new CashierPerSale($salesBook, $cart, $this->testObjects->expiredCreditCard(), $this->testObjects->today(), $this);
            $this->fail();
        } catch (Error $error){
    ...
    public function testCashierInformsRightTotalAndCreditCardToMerchantProcessor()
    {
        ...
        $cashier = new CashierPerSale($salesBook, $cart, $notExpiredCreditCard,
            $this->testObjects->today(), $this);
